...
export const BUILT_IN_FAMILIES = [
  ...
  makeFam('maths-aqa-pure',               'AQA Pure',                    'maths',         2018, 2024, (y) => `aqa-${y}-pure`),
  makeFam('maths-aqa-statistics',         'AQA Statistics',              'maths',         2018, 2024, (y) => `aqa-${y}-statistics`),
  makeFam('maths-aqa-mechanics',          'AQA Mechanics',               'maths',         2018, 2024, (y) => `aqa-${y}-mechanics`),
  makeFam('maths-edexcel-pure-1',         'Edexcel Pure 1',              'maths',         2018, 2024, (y) => `edexcel-${y}-pure-1`),
  makeFam('maths-edexcel-pure-2',         'Edexcel Pure 2',              'maths',         2018, 2024, (y) => `edexcel-${y}-pure-2`),
  makeFam('maths-edexcel-stats-mech',     'Edexcel Stats & Mechanics',   'maths',         2018, 2024, (y) => `edexcel-${y}-stats-and-mechanics`),
  ...
  makeFam('fm-aqa-core-pure-1',           'AQA Core Pure 1',             'furtherMaths',  2019, 2024, (y) => `aqa-${y}-core-pure-1`),
  makeFam('fm-aqa-core-pure-2',           'AQA Core Pure 2',             'furtherMaths',  2019, 2024, (y) => `aqa-${y}-core-pure-2`),
  makeFam('fm-aqa-mechanics',             'AQA Mechanics',               'furtherMaths',  2019, 2024, (y) => `aqa-${y}-mechanics`),
  makeFam('fm-edexcel-core-pure-1',       'Edexcel Core Pure 1',         'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-core-pure-1`),
  makeFam('fm-edexcel-core-pure-2',       'Edexcel Core Pure 2',         'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-core-pure-2`),
  makeFam('fm-edexcel-further-pure-1',    'Edexcel Further Pure 1',      'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-further-pure-1`),
  makeFam('fm-edexcel-further-pure-2',    'Edexcel Further Pure 2',      'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-further-pure-2`),
  makeFam('fm-edexcel-further-mech-1',    'Edexcel Further Mechanics 1', 'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-further-mechanics-1`),
  makeFam('fm-edexcel-further-mech-2',    'Edexcel Further Mechanics 2', 'furtherMaths',  2019, 2024, (y) => `edexcel-${y}-further-mechanics-2`),
