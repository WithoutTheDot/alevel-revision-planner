...
export const SUBJECT_META = {
  ...
  chemistry:      { label: 'Chemistry',       color: 'bg-amber-500',  text: 'text-amber-700',  light: 'bg-amber-100' },
  biology:        { label: 'Biology',         color: 'bg-teal-500',   text: 'text-teal-700',   light: 'bg-teal-100' },
  psychology:     { label: 'Psychology',      color: 'bg-pink-500',   text: 'text-pink-700',   light: 'bg-pink-100' },
  sociology:      { label: 'Sociology',       color: 'bg-violet-500', text: 'text-violet-700', light: 'bg-violet-100' },
  economics:      { label: 'Economics',       color: 'bg-orange-500', text: 'text-orange-700', light: 'bg-orange-100' },
  history:        { label: 'History',         color: 'bg-cyan-500',   text: 'text-cyan-700',   light: 'bg-cyan-100' },
  geography:      { label: 'Geography',       color: 'bg-lime-500',   text: 'text-lime-700',   light: 'bg-lime-100' },
  english:        { label: 'English Lit',     color: 'bg-rose-500',   text: 'text-rose-700',   light: 'bg-rose-100' },
  business:       { label: 'Business',        color: 'bg-amber-600',  text: 'text-amber-800',  light: 'bg-amber-50' },
  law:            { label: 'Law',             color: 'bg-teal-600',   text: 'text-teal-800',   light: 'bg-teal-50' },
  pe:             { label: 'Physical Ed',     color: 'bg-pink-600',   text: 'text-pink-800',   light: 'bg-pink-50' },
  statistics:     { label: 'Statistics',      color: 'bg-violet-600', text: 'text-violet-800', light: 'bg-violet-50' },
};
